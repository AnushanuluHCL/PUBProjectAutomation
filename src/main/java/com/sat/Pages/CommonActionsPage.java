...
public class CommonActionsPage {
    ...
    public static String TankerName, TankerCapacity, casenumber, Tankercompanyname, starttimeval, startdateval, permitnum, permitExpiryDate, GWCReferenceNum, case_FIO, case_SO, case_AO;
    ...
    public void changeAreaSelection(String changearea) {
        ...
        WebElement changeareaname = driver.findElement(By.xpath("//li[@role='menuitemradio']//span[text()='" + changearea + "']"));
