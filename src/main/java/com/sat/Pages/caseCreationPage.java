...
public class caseCreationPage extends CommonActionsPage {
    ...
    private By customerRadioButton = By.cssSelector("div[class='ms-Checkbox is-enabled RowSelectionCheckMarkSpan checkMark-205']");
    private By customerDepositAmount1 = By.xpath("//div[@aria-rowindex='2'] //label[@class='ms-Label labelRootStyles-236']");
    private By customerDepositAmount2 = By.xpath("//div[@aria-rowindex='3'] //label[@class='ms-Label labelRootStyles-236']");
    ...
    public void navigatingToStage(String stageName) {
        ...
        Runnable[] clickMethods = new Runnable[]{
                () -> eleUtil.doClickWithWait(clickOnStage, 40), // Standard click
        ...
        String[] clickMethodNames = new String[]{
                "Standard click",
                "Actions click",
                "JavaScript click"
        };
    ...
    public void completeInspection() {
        navigatingToStage("Inspection"); // comment this line if code is failed
    ...
    public void validateDeregisterNotification() throws InterruptedException {
        ...
        while (System.currentTimeMillis() < endTime) {
            ...
            Thread.sleep(3000);
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
            WebElement WOalert = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//p[contains(text(),'A tanker has been Deregistered " +
                    "and required your approval')]")));
            if (WOalert != null && WOalert.isDisplayed()) {
                ...
                if (caseNumberForDeregisterTanker.contains(actualCaseNumber)) {
                    ...
                    WebElement tapToOpenBtn = driver.findElement(By.xpath("//p[contains(text(),'A tanker has been Deregistered and required your approval')]/a"));
                    tapToOpenBtn.click();
                    ...
                    Log.info("afterTapToOpenBtn: " + afterTapToOpenBtn);
                    assertTrue(afterTapToOpenBtn.contains(CommonActionsPage.casenumber), "Case is not the same after clicking on tap to open button");
                    eleUtil.doElementClickable(saveCloseBtn, 20);
                    eleUtil.doClick(saveCloseBtn);
                    driver.switchTo().window(tabs.get(0));
                    eleUtil.doClick(cancelBtn);
