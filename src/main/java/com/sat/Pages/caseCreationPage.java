...
public class caseCreationPage extends commonActionsPage {
    ...
    private By customerDepositAmount1 = By
            .xpath("//div[@aria-rowindex='2'] //div[@col-id='pub_depositamount']");
    private By customerDepositAmount2 = By
            .xpath("//div[@aria-rowindex='3'] //div[@col-id='pub_depositamount']");
    ...
    public void paymentWasteTypeValidation() throws InterruptedException {
        ...
        assertEquals(actualWasteType, "Greasy Waste, Organic Sludge – Ships, Organic Sludge – Industries", "Waste type is not matching");
    }
    ...
    public void paymentRecordAfterActualQuantitiesValidation(int GWPerMonth, int OSSPerMonth, int OSIPerMonth, int GWActual, int OSActual)
            throws InterruptedException {
        // Calculation for Payment
        float totalOSEstimatedQuantity = OSSPerMonth + OSIPerMonth;
        float totalActualCalDepositOS = totalOSEstimatedQuantity * 38;
        ...
        assertEquals(actualCalculatedDepositActual, totalDeposit, "Calculated Deposit Based on Actual Volume not matching");
    ...
    public void paymentRecordAfterDepositQuantitiesValidation(int GWPerMonth, int OSSPerMonth, int OSIPerMonth, int GWActual, int OSActual, int expectedDepositAmount)
            throws InterruptedException {
        float totalOSEstimatedQuantity = OSSPerMonth + OSIPerMonth;
        float totalActualCalDepositOS = totalOSEstimatedQuantity * 38;
        float totalActualCalDepositGW = (float) (GWPerMonth * 10.8605f);
