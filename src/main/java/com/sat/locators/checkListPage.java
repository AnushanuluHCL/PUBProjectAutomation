...
public class checkListPage extends commonCRMActions {
	...
	public void fillCheckListQuestionsForWRN6IMB(String allWorkComplete, String value) throws InterruptedException {
		...
		for (int i = 0; i < woNum.size(); i++) {
			Thread.sleep(2000);
			crmActions.openCheckList(woNum.get(i), "WRN 6 IMB Pumping Main Construction Site Inspection Checklist", "In Progress");
			selectChecklistForWRN6IMB(allWorkComplete, value);
			crmActions.saveChecklist();
		}
	}

	public void selectChecklistForWRN6IMB(String allWorkComplete, String value) throws InterruptedException {
