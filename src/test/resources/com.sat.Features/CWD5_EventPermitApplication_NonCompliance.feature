@CWD5EventPermitApplicationForNonCompliance
Feature: Testing CWD5- Event Permit Application for Non-Compliance.
  ...
  Scenario: Event Permit Application for Non-Compliance flow
	...
	And open "In Progress" WO fill the checklist for event inspection "Pre-Event Inspection" for "Non-Compliance" and verify WO status as "Completed"
	# checklist need to update- First apply sorting, then complete it for "During Event Inspection Checklist"
	And go to "Work Orders" tab
	And open "In Progress" WO fill the checklist for event inspection "During Event Inspection" for "Non-Compliance" and verify WO status as "Completed"
