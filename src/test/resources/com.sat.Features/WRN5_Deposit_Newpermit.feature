...
Feature: Testing deposit amount calculations for the tanker
  ...
  Scenario Outline: Validate the Deposit amount calculation process for the Tanker
	...
	And user selects entity as "Payment"
	Then Verify the payment validation after creating actual quantities for <GWPerMonth>, <OSSPerMonth> and <OSIPerMonth>
	...
	And Upload excel file for Deposit Amount calculation with deposit amount as "500.00" and giro as "R"
	And user selects entity as "Payment"
	# Verify payment validation after creating deposit quantities with GIRO
	Then Verify the payment validation after creating deposit quantities for <GWPerMonth>, <OSSPerMonth> and <OSIPerMonth>
	And user selects entity as "Deposits"
	# Create excel without GIRO
	And Update excel with GIRO value as " " for Deposit Amount calculation
	And Upload excel file for Deposit Amount calculation with deposit amount as "500.00" and giro as " "
	And user selects entity as "Payment"
